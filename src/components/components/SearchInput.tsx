  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center w-full gap-3 md:w-2/3 md:flex-row lg:justify-center lg:items-center">
        ...
        <button
          type="submit"
          className="inline-flex items-center justify-center w-1/2 gap-2 px-6 py-4 text-sm font-semibold text-white transition-all bg-red-500 border border-transparent rounded-full lg:w-auto hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800"
        >
          Get
        </button>
      </div>

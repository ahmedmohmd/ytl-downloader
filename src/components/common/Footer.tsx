        ...
        <span className="inline-flex items-center justify-center mt-4 sm:ml-auto sm:mt-0 sm:justify-start">
          <div className="flex items-center justify-center gap-2 text-xl social-icons ">
            <a
              ...
              target="_blank"
              className="p-2 duration-500 bg-gray-400 rounded-xl hover:bg-[#3b5998]"
            >
              <svg
                width={20}
                height={20}
            ...
            <a
              ...
              target="_blank"
              className="p-2 duration-500 bg-gray-400 rounded-xl hover:bg-[#55acee]"
            >
              <svg
                width={20}
                height={20}
            ...
            <a
              ...
              target="_blank"
              className="p-2 duration-500 bg-gray-400 rounded-xl hover:bg-[#3077b5]"
            >
              <svg
                width={20}
                height={20}
            ...
            <a
              ...
              target="_blank"
              className="p-2 duration-500 bg-gray-400 rounded-xl hover:bg-[#161b22]"
            >
              <svg
                width={20}
                height={20}
